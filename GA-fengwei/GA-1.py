...
penalty_coeff2 = 400
# 待分析文件路径
filepath = r'/Volumes/PHD/Pycharmdata/final GA-5/test.sch'
...
if __name__ == '__main__':
    ...
    costlist,initial_population = initializePopulation(30)
    costlist_now, population_now = GA_OneStep(costlist, initial_population, 30, 50, mutate_num=3, stop=20)
