...
def GA_Mode(initial_cost, initial_mode, population_num = 10, number_iter = 10, stop = -1, show = True, mutate_num = 1):
    if(stop < 0):
        stop = number_iter
...
def searchBestModeAndTime(modepopulation, modecost, initialnum = 10, generationnum = 10, number_iter = 10, stop = -1, show = True, mutate_num = 1):
    bestCost = float("inf")
    searchNum = 0
...
def GA_Time(bestMode, initial_cost, initial_time, population_num=10, number_iter=10, stop=-1, show=True, mutate_num=1):
    if(stop < 0):
        stop = number_iter
    print('-------------------------------------------')
...
if __name__ == '__main__':
    ...
    bestMode, bestTime, bestCost = searchBestModeAndTime(mode, costmode, initialnum=30, generationnum=30,number_iter=50,
                                                       mutate_num=3, stop=10)
